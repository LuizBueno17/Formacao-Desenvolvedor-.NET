...
namespace CasaDoCodigo.Models
{
    ...
    public class Produto : BaseModel
    {
        ...
        //Funcionalidade #1.3 - A classe Produto (no arquivo \Models\modelo.cs) possui a propriedade Categoria?
        [Required]
        [DataMember]
    ...
    //Funcionalidade #1.1 - A classe Categoria foi criada (no arquivo \Models\modelo.cs)?
    //Funcionalidade #1.2 - A classe Categoria herda da classe base BaseModel?
